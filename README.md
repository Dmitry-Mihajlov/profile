...
Я начинающий разработчик. Мой путь в it начался с интенсивов по разработке на Python. После них был промежуток в пару месяцев, где я пробовал себя во многих направлениях, изучал язык C++, информационную безопасность, web-разработку. С мая 2022 года по сей день я продолжаю изучать разработку интерфейсов и программных обеспечений на двух основынх языках Python и C++, прохожу обучение на курсах и участвую в олимпиадах по программированию.
